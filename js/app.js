 ...
 */
    ...
    (() => {
        ...
        function rangeInit() {
            var arbitraryValuesSlider = document.querySelector(".price__slider");
            var arbitraryValuesForSlider = [ "R 13-15", "R 16", "R 17", "R 18", "R 19", "R 20", "R 21-22" ];
            var format = {
                to: function(value) {
        ...
        const add_class_on_scroll = () => header.classList.add("header__top-fixed");
        const remove_class_on_scroll = () => header.classList.remove("header__top-fixed");
